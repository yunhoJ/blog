...
export const aboutProfile: AboutProfile = {
	...
	summary: [
		...
		'',
		'보안 솔루션(AEZIZ)의 설계부터 개발, 금융권 배포, 유지보수까지 전 과정을 직접 경험하며 성공적으로 구축하고 고도화했습니다.',
		'Jenkins 기반 CI/CD와 폐쇄망 배포 자동화 스크립트를 구축하여 패키징과 배포 공수를 70%이상 단축시켰으며 백엔드 리팩토링을 통해 API의 안정성과 성능을 개선했습니다.',
	],
	highlights: [
		{
			title: '조회 API 성능 개선',
