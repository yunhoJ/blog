...
export default async function BlogPost({ params }: BlogPostProps) {
	...
	return (
		<div className="container mx-auto flex h-full flex-col gap-2 space-y-4 px-4 py-8">
			{/* 헤더 */}
			...
			<div className="flex h-30 gap-5">
				<Button className="flex h-full w-1/2 flex-col items-start gap-4 overflow-hidden border-2 bg-transparent text-black">
					...
					<div className="line-clamp-2 w-full text-xs break-words text-ellipsis whitespace-normal text-gray-500">
						...
						입니다. 이전 화면 샘플내용 입니다. 이전 화면 샘플내용 입니다. 이전 화면 샘플내용 입니다.
						이전 화면 샘플내용 입니다. 이전 화면 샘플내용 입니다. 이전 화면 샘플내용 입니다. 이전
						화면 샘플내용 입니다. 이전 화면 샘플내용 입니다.
					</div>
				</Button>
				<Button className="flex h-full w-1/2 flex-col items-end gap-4 overflow-hidden border-2 bg-transparent text-ellipsis text-black">
					...
					<div className="line-clamp-2 w-full text-end text-xs break-words text-ellipsis whitespace-normal text-gray-500">
						...
						flex 컨테이너에서 자식 요소가 min-w-0이 아니면 줄바꿈이 안 될 수 있지만, 이미 min-w-0을
						적용했습니다. Tailwind 플러그인 미설치 line-clamp 유틸리티는 Tailwind CSS의 공식
						플러그인(@tailwindcss/line-clamp)이 설치되어 있어야 동작합니다. tailwind.config.js의
						plugins에 require가 포함되어 있어야 합니다.
					</div>
				</Button>
			</div>
		</div>
